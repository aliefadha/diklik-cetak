...
export const Route = createFileRoute('/document-printing')({
  component: DocumentPrintingPage,
})

const categories = [
  { name: "Documen Printing", path: "/document-printing", active: true },
...
const items = [
  { name: "Map Folder", image: "map-folder.webp" },
  { name: "ID Card PVC", image: "id-card.webp" },
  { name: "Sertifikat & Piagam", image: "sertifikat.webp" },
  { name: "Buku", image: "buku.webp" },
];
    ...
    <main className="w-full">
      ...
      <section className="relative flex w-full flex-col items-center justify-center overflow-hidden h-[300px] md:h-[400px]">
        <div 
          ...
          style={{ backgroundImage: "url('documen-printing.webp')" }}
        >
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-3xl mx-auto text-white mt-8 md:mt-12">
          ...
          <p className="text-sm md:text-base leading-relaxed max-w-xl text-gray-200">
            Kami menghadirkan solusi cetak dan branding terintegrasi untuk mendukung identitas visual dan kebutuhan promosi Anda
          </p>
        </div>
      </section>
