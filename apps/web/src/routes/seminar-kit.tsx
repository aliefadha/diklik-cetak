...
export const Route = createFileRoute('/seminar-kit')({
  component: SeminarKitPage,
})

const categories = [
  { name: "Documen Printing", path: "/document-printing", active: false },
  { name: "Merchandise", path: "/merchandise", active: false },
  { name: "Seminar Kit", path: "/seminar-kit", active: true },
  { name: "Media Promosi", path: "/media-promosi", active: false },
];

const items = [
  { name: "ID Card Peserta", image: "id-card-peserta.webp" },
  { name: "Lanyard", image: "lanyard.webp" },
  { name: "Notebook", image: "notebook.webp" },
  { name: "Pulpen", image: "pulpen.webp" },
  { name: "Plakat", image: "plakat.webp" },
];

function SeminarKitPage() {
  return (
    <main className="w-full">
      ...
      <section className="relative flex w-full flex-col items-center justify-center overflow-hidden h-[300px] md:h-[400px]">
        <div
          ...
          style={{ backgroundImage: "url('seminar-kit.webp')" }}
        >
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-3xl mx-auto text-white mt-8 md:mt-12">
          ...
          <p className="text-sm md:text-base leading-relaxed max-w-xl text-gray-200">
            Paket perlengkapan kegiatan seperti seminar, workshop, atau event yang terdiri dari tas seminar, lanyard, ID card, notebook, pulpen, dan kebutuhan event lainnya.
          </p>
        </div>
      </section>
